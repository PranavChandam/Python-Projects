...
class Bill_App:
    def __init__(self,root):
     ...
     #Customer Detail Frame
      ...
      f6=LabelFrame(self.root,text="Bill Taxes",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
    ...
    # Validate customer phone number
      ...
      if phone[0] not in ['7','8','9']:
        messagebox.showerror("Error", "Phone number must start with 7,8 or 9")
        return
